...
if __name__ == "__main__":
    ...
    concated_topic_gt_pred_file = "/data/sc159/LLaVARad/results/topic_seg/llavarad_MIMIC_onlyMLP/test_merged.jsonl"
    ori_report_file = "/data/sc159/data/MIMIC_III/llava_rad_topic/chat_test_MIMIC_CXR_all_gpt4extract_rulebased_v4.json"
    output_file = "/data/sc159/LLaVARad/results/topic_seg/llavarad_MIMIC_onlyMLP/oriReport_predTopic.jsonl"
