...
if __name__ == "__main__":
    ...
    input_files = [
        "/data/sc159/LLaVARad/results/topic_seg/llavarad_MIMIC_onlyMLP/test_0.jsonl",
        "/data/sc159/LLaVARad/results/topic_seg/llavarad_MIMIC_onlyMLP/test_1.jsonl",
        "/data/sc159/LLaVARad/results/topic_seg/llavarad_MIMIC_onlyMLP/test_2.jsonl",
        "/data/sc159/LLaVARad/results/topic_seg/llavarad_MIMIC_onlyMLP/test_3.jsonl"
    ]
    output_file = "/data/sc159/LLaVARad/results/topic_seg/llavarad_MIMIC_onlyMLP/test_merged.jsonl"
