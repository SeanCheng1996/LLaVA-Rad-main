...
from llava.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, \
    DEFAULT_IM_END_TOKEN, MASK_THRESH, ORGAN_MASK_MAPPING
...
class DataArguments:
    ...
    mask_path: str = field(default=None, metadata={"help": "Path to mask data."})
    loader: str = "default"
...
class LazySupervisedDataset(Dataset):
    ...
    def lengths(self):
        ...
        for sample in self.list_data_dict:
            img_tokens = 128 if 'image' in sample else 0  # todo, why 128
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'image' in sources[0]:
            ...
            if self.data_args.image_aspect_ratio == 'pad':
                ...
                image = processor.preprocess(image, return_tensors='pt')['pixel_values'][0]  # 3*518*518
                masked_img = processor.preprocess(masked_img, return_tensors='pt')['pixel_values'][0]  # 3*518*518
        ...
        if 'image' in self.list_data_dict[i]:
            ...
            data_dict['masked_image'] = masked_img
