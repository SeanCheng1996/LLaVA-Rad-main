...
if __name__ == '__main__':
    ...
    # id_report_json=extractReport(f"/data/sc159/data/IU_Xray_raw/processed/all_llavarad_format.json")
    ...
    for i in tqdm(range(0, len(id_report_json), interval), desc="Processing batches"):
        ...
        # dest_file=f"/data/sc159/data/IU_Xray_raw/processed/{system_prompt_cate}/prompts/{split}_prompts_{i}_{i + interval}.jsonl"
