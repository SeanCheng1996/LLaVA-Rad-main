...
model_path=/work/devika/sc159/llava_rad/LLaVA-Rad-main/checkpoints_topic_seg_a100/llava_biomedclip_cxr_518-pt-1e-1e-3-20250710031958

model_base="${1:-$model_base}"
model_path="${2:-$model_path}"
prediction_dir="${3:-results/topic_seg/llavarad_IUXRay_onlyMLP}"
...
query_file=/work/devika/data/IU_Xray_raw/processed/llava_rad_topic/all_llavarad_format_v2.json

# image_folder=/PATH_TO/physionet.org/files/mimic-cxr-jpg/2.0.0/files
image_folder=/work/devika/data/IU_Xray_raw/images/images_normalized
mask_path=/work/devika/data/IU_Xray_raw/images/segmentation_single
loader="iuxray_test_topic_findings"
conv_mode="v1"
